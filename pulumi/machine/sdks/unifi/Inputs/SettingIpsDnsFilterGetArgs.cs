...
namespace Pulumi.Unifi.Inputs
{
    ...
    public sealed class SettingIpsDnsFilterGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedSites")]
        ...
        public SettingIpsDnsFilterGetArgs()
        {
        }
        public static new SettingIpsDnsFilterGetArgs Empty => new SettingIpsDnsFilterGetArgs();
    }
}
