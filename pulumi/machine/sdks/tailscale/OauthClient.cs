...
namespace Pulumi.Tailscale
{
    ...
    public partial class OauthClient : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// A list of tags that access tokens generated for the OAuth client will be able to assign to devices. Mandatory if the
        /// scopes include "devices:core" or "auth_keys".
        /// </summary>
        [Output("tags")]
        ...
        public OauthClient(string name, OauthClientArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/oauthClient:OauthClient", name, args ?? new OauthClientArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private OauthClient(string name, Input<string> id, OauthClientState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/oauthClient:OauthClient", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
