...
namespace Pulumi.Unifi.Inputs
{
    ...
    public sealed class SettingUsgUpnpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SettingUsgUpnpArgs()
        {
        }
        public static new SettingUsgUpnpArgs Empty => new SettingUsgUpnpArgs();
    }
}
