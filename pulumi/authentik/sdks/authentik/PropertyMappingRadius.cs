...
namespace Pulumi.Authentik
{
    ...
    public partial class PropertyMappingRadius : global::Pulumi.CustomResource
    {
        ...
        [Output("propertyMappingRadiusId")]
        public Output<string> PropertyMappingRadiusId { get; private set; } = null!;
        ...
        public PropertyMappingRadius(string name, PropertyMappingRadiusArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingRadius:PropertyMappingRadius", name, args ?? new PropertyMappingRadiusArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private PropertyMappingRadius(string name, Input<string> id, PropertyMappingRadiusState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingRadius:PropertyMappingRadius", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class PropertyMappingRadiusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("propertyMappingRadiusId")]
        public Input<string>? PropertyMappingRadiusId { get; set; }
