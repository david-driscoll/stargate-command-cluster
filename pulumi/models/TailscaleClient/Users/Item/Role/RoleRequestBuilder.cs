...
namespace Tailscale.Client.Users.Item.Role
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Tailscale.Client.Users.Item.Role.RoleRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(global::Tailscale.Client.Users.Item.Role.RolePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::Tailscale.Client.Users.Item.Role.RolePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Tailscale.Client.Users.Item.Role.RolePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Tailscale.Client.Users.Item.Role.RolePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>DoUpdate <see cref="global::Tailscale.Client.Users.Item.Role.RoleRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Tailscale.Client.Users.Item.Role.RoleRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Tailscale.Client.Users.Item.Role.RoleRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
