...
namespace Pulumi.Tailscale
{
    ...
    {
        [Output("dnsPreferencesId")]
        public Output<string> DnsPreferencesId { get; private set; } = null!;
        ...
        public DnsPreferences(string name, DnsPreferencesArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsPreferences:DnsPreferences", name, args ?? new DnsPreferencesArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private DnsPreferences(string name, Input<string> id, DnsPreferencesState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsPreferences:DnsPreferences", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    {
        [Input("dnsPreferencesId")]
        public Input<string>? DnsPreferencesId { get; set; }
