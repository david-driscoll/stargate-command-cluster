...
namespace Pulumi.Tailscale
{
    ...
    {
        [Output("dnsNameserversId")]
        public Output<string> DnsNameserversId { get; private set; } = null!;
        ...
        public DnsNameservers(string name, DnsNameserversArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsNameservers:DnsNameservers", name, args ?? new DnsNameserversArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private DnsNameservers(string name, Input<string> id, DnsNameserversState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsNameservers:DnsNameservers", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    {
        [Input("dnsNameserversId")]
        public Input<string>? DnsNameserversId { get; set; }
