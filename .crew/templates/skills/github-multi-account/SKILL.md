...
confidence: high
source: https://github.com/tamirdresher/crew-skills/tree/main/plugins/github-multi-account
author: tamirdresher
---
...
$binDir = Join-Path $env:USERPROFILE ".crew\bin"
...
This repo (`Blacklite/crew`) is bound to the **bradygaster** (personal) account.
