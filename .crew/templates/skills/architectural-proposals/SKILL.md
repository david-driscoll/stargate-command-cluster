...
tools:
  - name: "view"
    ...
    when: "Always read .crew/decisions.md, relevant PRDs, and current architecture docs before writing proposal"
  - name: "create"
...
- Wave 2 (DEFERRED): CrewUI — waits for shell foundation
...
- Log all SDK events to `.crew/orchestration-log/sdk-events.jsonl` for debugging
```

## Examples

**File references from interactive shell proposal:**
- Full proposal: `docs/proposals/crew-interactive-shell.md`
- User directive: `.crew/decisions/inbox/copilot-directive-2026-02-21T202535Z.md`
- Team decisions: `.crew/decisions.md`
...
7. Preserve backward compatibility (crew.agent.md still works, VS Code mode unchanged)
