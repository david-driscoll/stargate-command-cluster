...
#nullable restore
        ...
        public string Os { get; set; }
#endif
        /// <summary>&gt; ⓘ This field is available for [Enterprise plans](/pricing).Contains extra identifiers from the device when the tailnet it is connected to has device posture identification collection enabled.If the device has not opted-in to posture identification collection, this will contain {&quot;disabled&quot;: true}.Learn more about posture identity at https://tailscale.com/kb/1326/device-identity.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
