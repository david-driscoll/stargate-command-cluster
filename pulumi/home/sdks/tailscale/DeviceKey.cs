...
namespace Pulumi.Tailscale
{
    ...
    public partial class DeviceKey : global::Pulumi.CustomResource
    {
        ...
        [Output("deviceKeyId")]
        public Output<string> DeviceKeyId { get; private set; } = null!;
        ...
        public DeviceKey(string name, DeviceKeyArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceKey:DeviceKey", name, args ?? new DeviceKeyArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private DeviceKey(string name, Input<string> id, DeviceKeyState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceKey:DeviceKey", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class DeviceKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("deviceKeyId")]
        public Input<string>? DeviceKeyId { get; set; }
