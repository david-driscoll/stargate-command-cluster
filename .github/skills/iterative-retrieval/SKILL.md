...
Crew agents frequently spawn sub-agents to complete scoped work. Without structure, these
...
3. **Cycle 3 exhausted** → escalate: write a summary to `.crew/decisions/inbox/`, label the
...
- Decision recorded in `.crew/decisions/inbox/`
...
```
## Task
Add an "Iterative Retrieval Protocol" section to `.crew/agents/coordinator/charter.md` explaining
