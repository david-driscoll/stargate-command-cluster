...
namespace Pulumi.Proxmox.Inputs
{
    ...
    public sealed class LxcFeaturesGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("fuse")]
        ...
        public LxcFeaturesGetArgs()
        {
        }
        public static new LxcFeaturesGetArgs Empty => new LxcFeaturesGetArgs();
    }
}
