...
namespace Pulumi.Authentik
{
    ...
    public partial class PropertyMappingSourceScim : global::Pulumi.CustomResource
    {
        ...
        [Output("propertyMappingSourceScimId")]
        public Output<string> PropertyMappingSourceScimId { get; private set; } = null!;
        ...
        public PropertyMappingSourceScim(string name, PropertyMappingSourceScimArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingSourceScim:PropertyMappingSourceScim", name, args ?? new PropertyMappingSourceScimArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private PropertyMappingSourceScim(string name, Input<string> id, PropertyMappingSourceScimState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingSourceScim:PropertyMappingSourceScim", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class PropertyMappingSourceScimArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("propertyMappingSourceScimId")]
        public Input<string>? PropertyMappingSourceScimId { get; set; }
