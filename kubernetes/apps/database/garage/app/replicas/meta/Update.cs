...
if (clusterValuesRoot.Query("/spec/values/controllers/garage/statefulset/volumeClaimTemplates/0/size").OfType<YamlScalarNode>().SingleOrDefault() is { } dataSizeNode)
{
