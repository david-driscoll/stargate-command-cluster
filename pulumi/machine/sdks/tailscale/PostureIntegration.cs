...
namespace Pulumi.Tailscale
{
    ...
    public partial class PostureIntegration : global::Pulumi.CustomResource
    {
        ...
        [Output("postureIntegrationId")]
        public Output<string> PostureIntegrationId { get; private set; } = null!;
        ...
        public PostureIntegration(string name, PostureIntegrationArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/postureIntegration:PostureIntegration", name, args ?? new PostureIntegrationArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private PostureIntegration(string name, Input<string> id, PostureIntegrationState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/postureIntegration:PostureIntegration", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class PostureIntegrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("postureIntegrationId")]
        public Input<string>? PostureIntegrationId { get; set; }
