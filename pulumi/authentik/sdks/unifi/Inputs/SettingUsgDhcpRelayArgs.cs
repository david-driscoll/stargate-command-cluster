...
namespace Pulumi.Unifi.Inputs
{
    ...
    public sealed class SettingUsgDhcpRelayArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SettingUsgDhcpRelayArgs()
        {
        }
        public static new SettingUsgDhcpRelayArgs Empty => new SettingUsgDhcpRelayArgs();
    }
}
