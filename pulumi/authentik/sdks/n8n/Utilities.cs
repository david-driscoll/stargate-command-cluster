...
namespace Pulumi.N8n
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "n8n",
                    version: "0.1.3",
                    value: global::System.Convert.FromBase64String("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Rldm9wczI0Ny1vbmxpbmUvbjhuIiwidmVyc2lvbiI6IjAuMS4zIn19")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.N8n.version.txt");
    ...
    internal sealed class N8nResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public N8nResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
