...
namespace Pulumi.Unifi.Inputs
{
    ...
    public sealed class SettingUsgDhcpRelayGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("agentsPackets")]
        public Input<string>? AgentsPackets { get; set; }
        ...
        /// </summary>
        [Input("hopCount")]
        public Input<double>? HopCount { get; set; }
        ...
        public SettingUsgDhcpRelayGetArgs()
        {
        }
        public static new SettingUsgDhcpRelayGetArgs Empty => new SettingUsgDhcpRelayGetArgs();
    }
}
