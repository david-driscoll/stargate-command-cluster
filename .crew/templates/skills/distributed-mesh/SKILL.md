...
Using the answers from Step 1, create a `mesh.json` file at the project root. Use `mesh.json.example` from THIS skill's directory (`.crew/skills/distributed-mesh/mesh.json.example`) as the schema template.
...
- **Source:** `.crew/skills/distributed-mesh/sync-mesh.sh`
- **Destination:** `sync-mesh.sh` (project root)

- **Source:** `.crew/skills/distributed-mesh/sync-mesh.ps1`
