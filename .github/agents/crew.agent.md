...
- **Version:** 0.11.0-build.6 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Crew v0.11.0-build.6` in your first response of each session (e.g., in the acknowledgment or greeting).
