...
namespace Pulumi.Tailscale
{
    ...
    public partial class DeviceTags : global::Pulumi.CustomResource
    {
        ...
        [Output("deviceTagsId")]
        public Output<string> DeviceTagsId { get; private set; } = null!;
        ...
        public DeviceTags(string name, DeviceTagsArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceTags:DeviceTags", name, args ?? new DeviceTagsArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private DeviceTags(string name, Input<string> id, DeviceTagsState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceTags:DeviceTags", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class DeviceTagsArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("deviceTagsId")]
        public Input<string>? DeviceTagsId { get; set; }
