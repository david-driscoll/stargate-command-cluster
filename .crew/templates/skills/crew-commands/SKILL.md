...
name: crew-commands
description: >
  Categorized catalog of common Crew operations. Coordinator reads this
  file and presents it as an interactive menu when the user asks for
  available commands or help.
domain: crew-operations
confidence: high
source: first-party
triggers: ["crew commands", "what can crew do", "show me crew options", "slash commands"]
---

## Menu Presentation Rules

When the user triggers this skill ("crew commands", "help", "what can crew do", etc.):
...
- **summary:** List all skills installed in .crew/skills/ and .copilot/skills/
- **action:** coordinator
- **command:** Direct Mode — list .crew/skills/ and .copilot/skills/ directories
- **args:** (none)
- **confirm:** false
