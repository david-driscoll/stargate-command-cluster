...
namespace Pulumi.Proxmox.Inputs
{
    ...
    public sealed class LxcTimeoutsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("create")]
        ...
        public LxcTimeoutsGetArgs()
        {
        }
        public static new LxcTimeoutsGetArgs Empty => new LxcTimeoutsGetArgs();
    }
}
