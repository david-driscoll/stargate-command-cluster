...
namespace Pulumi.Uptimekuma
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Uptimekuma.version.txt");
    ...
    internal sealed class UptimekumaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public UptimekumaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
