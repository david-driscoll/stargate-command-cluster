...
namespace Pulumi.Tailscale
{
    ...
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// The provider type of the endpoint URL. Also referred to as the 'destination' for the webhook in the admin panel. Webhook
        /// event payloads are formatted according to the provider type if it is set to a known value. Must be one of `slack`,
        /// `mattermost`, `googlechat`, or `discord` if set.
        /// </summary>
        [Output("providerType")]
        public Output<string?> ProviderType { get; private set; } = null!;

        /// <summary>
        /// The secret used for signing webhook payloads. Only set on resource creation. See
        /// https://tailscale.com/kb/1213/webhooks#webhook-secret for more information.
        /// </summary>
        [Output("secret")]
        public Output<string> Secret { get; private set; } = null!;

        /// <summary>
        /// The Tailscale events to subscribe this webhook to. See https://tailscale.com/kb/1213/webhooks#events for the list of
        /// valid events.
        /// </summary>
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/webhook:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private Webhook(string name, Input<string> id, WebhookState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/webhook:Webhook", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
