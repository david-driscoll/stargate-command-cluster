...
namespace Pulumi.Authentik
{
    ...
    public partial class PropertyMappingNotification : global::Pulumi.CustomResource
    {
        ...
        [Output("propertyMappingNotificationId")]
        public Output<string> PropertyMappingNotificationId { get; private set; } = null!;
        ...
        public PropertyMappingNotification(string name, PropertyMappingNotificationArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingNotification:PropertyMappingNotification", name, args ?? new PropertyMappingNotificationArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private PropertyMappingNotification(string name, Input<string> id, PropertyMappingNotificationState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingNotification:PropertyMappingNotification", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class PropertyMappingNotificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("propertyMappingNotificationId")]
        public Input<string>? PropertyMappingNotificationId { get; set; }
