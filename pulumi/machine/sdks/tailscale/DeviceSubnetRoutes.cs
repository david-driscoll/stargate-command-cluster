...
namespace Pulumi.Tailscale
{
    ...
    public partial class DeviceSubnetRoutes : global::Pulumi.CustomResource
    {
        ...
        [Output("deviceSubnetRoutesId")]
        public Output<string> DeviceSubnetRoutesId { get; private set; } = null!;
        ...
        public DeviceSubnetRoutes(string name, DeviceSubnetRoutesArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceSubnetRoutes:DeviceSubnetRoutes", name, args ?? new DeviceSubnetRoutesArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private DeviceSubnetRoutes(string name, Input<string> id, DeviceSubnetRoutesState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/deviceSubnetRoutes:DeviceSubnetRoutes", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class DeviceSubnetRoutesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("deviceSubnetRoutesId")]
        public Input<string>? DeviceSubnetRoutesId { get; set; }
