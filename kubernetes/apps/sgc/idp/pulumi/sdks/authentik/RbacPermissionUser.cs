...
namespace Pulumi.Authentik
{
    ...
    public partial class RbacPermissionUser : global::Pulumi.CustomResource
    {
        ...
        [Output("rbacPermissionUserId")]
        public Output<string> RbacPermissionUserId { get; private set; } = null!;
        ...
        public RbacPermissionUser(string name, RbacPermissionUserArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/rbacPermissionUser:RbacPermissionUser", name, args ?? new RbacPermissionUserArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private RbacPermissionUser(string name, Input<string> id, RbacPermissionUserState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/rbacPermissionUser:RbacPermissionUser", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class RbacPermissionUserArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rbacPermissionUserId")]
        public Input<string>? RbacPermissionUserId { get; set; }
