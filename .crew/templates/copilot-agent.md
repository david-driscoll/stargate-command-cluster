...
On-demand reference for adding the GitHub Copilot coding agent (@copilot) to the Crew roster.
...
| Branch convention | `crew/{issue}-{slug}` | `copilot/{slug}` |
| Trigger | Coordinator spawns directly | Issue assignment |
| Charter source | `.crew/agents/{name}/charter.md` | `.github/copilot-instructions.md` |
