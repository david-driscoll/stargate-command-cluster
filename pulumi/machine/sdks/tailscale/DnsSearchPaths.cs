...
namespace Pulumi.Tailscale
{
    ...
    {
        [Output("dnsSearchPathsId")]
        public Output<string> DnsSearchPathsId { get; private set; } = null!;
        ...
        public DnsSearchPaths(string name, DnsSearchPathsArgs args, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsSearchPaths:DnsSearchPaths", name, args ?? new DnsSearchPathsArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private DnsSearchPaths(string name, Input<string> id, DnsSearchPathsState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/dnsSearchPaths:DnsSearchPaths", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    {
        [Input("dnsSearchPathsId")]
        public Input<string>? DnsSearchPathsId { get; set; }
