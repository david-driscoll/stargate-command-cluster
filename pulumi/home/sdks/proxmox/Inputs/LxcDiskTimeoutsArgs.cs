...
namespace Pulumi.Proxmox.Inputs
{
    ...
    public sealed class LxcDiskTimeoutsArgs : global::Pulumi.ResourceArgs
    {
        [Input("create")]
        ...
        public LxcDiskTimeoutsArgs()
        {
        }
        public static new LxcDiskTimeoutsArgs Empty => new LxcDiskTimeoutsArgs();
    }
}
