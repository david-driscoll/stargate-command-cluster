...
name: crew
description: >-
  Crew's command catalog and interactive menu. Invoke via /crew (slash command) or natural language ("crew commands", "what can crew do", "show me crew options"). Presents categorized operations (Install & Upgrade, Team Management, Issues & PRs, Plugins & Skills, Model & Cost, Sessions & State) as an interactive picker. Routes to the right crew CLI command or the Crew coordinator agent.
user-invocable: true
allowedTools: []
---
...
When the user triggers this skill (via `/crew` slash command, "crew commands", "help", "what can crew do", etc.):
...
- **intent:** upgrade crew, update crew, install latest version, get new version
- **summary:** Upgrade Crew CLI to the latest version for your channel
- **action:** shell
- **command:** crew upgrade
- **args:**
...
- **intent:** set up crew, initialize crew, create team, start crew in this project
- **summary:** Scaffold Crew in the current directory (idempotent)
- **action:** shell
- **command:** crew init
- **args:** (none)
- **confirm:** false
...
- **summary:** Change where Crew stores mutable state (config.json)
- **action:** file-edit
- **command:** .crew/config.json → stateBackend
- **args:**
...
- **intent:** start watch, crew watch, monitor issues, watch for issues, auto-triage
- **summary:** Start crew watch to continuously poll and triage issues
- **action:** shell
- **command:** crew watch
- **args:**
  - `interval`: Poll interval in minutes | default: 10
- **confirm:** false
- **platform_caveats:** CLI-only — long-running foreground process. Not viable in VS Code without an integrated terminal. Run: `crew watch --interval {n}` in your terminal.
...
- **summary:** Browse available plugins in the Crew marketplace
- **action:** shell
- **command:** crew plugin marketplace browse
- **args:**
...
- **summary:** Add a plugin from the marketplace to this Crew
- **action:** shell
- **command:** crew plugin marketplace add
- **args:**
...
- **action:** shell
- **command:** crew plugin marketplace remove
- **args:**
...
- **summary:** List all plugins registered in this Crew
- **action:** shell
- **command:** crew plugin marketplace list
- **args:** (none)
- **confirm:** false
...
- **summary:** List all skills installed in .crew/skills/, .github/skills/, and .claude/skills/
- **action:** coordinator
- **command:** Direct Mode — list .crew/skills/, .github/skills/, and .claude/skills/ directories
- **args:** (none)
- **confirm:** false
...
- **action:** file-edit
- **command:** .crew/config.json → defaultModel
- **args:**
...
- **action:** file-edit
- **command:** .crew/config.json → agentModelOverrides.{agentName}
- **args:**
...
- **action:** file-edit
- **command:** .crew/config.json → remove defaultModel or agentModelOverrides.{agentName}
- **args:**
...
- **summary:** Display recent entries from .crew/decisions.md
- **action:** coordinator
...
- **action:** coordinator
- **command:** Move entries older than threshold from .crew/decisions.md → .crew/decisions-archive.md
- **args:**
