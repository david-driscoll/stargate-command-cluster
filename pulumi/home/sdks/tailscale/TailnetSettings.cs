...
namespace Pulumi.Tailscale
{
    ...
    public partial class TailnetSettings : global::Pulumi.CustomResource
    {
        ...
        public Output<double> DevicesKeyDurationDays { get; private set; } = null!;
        ...
        [Output("tailnetSettingsId")]
        public Output<string> TailnetSettingsId { get; private set; } = null!;
        ...
        public TailnetSettings(string name, TailnetSettingsArgs? args = null, CustomResourceOptions? options = null)
            : base("tailscale:index/tailnetSettings:TailnetSettings", name, args ?? new TailnetSettingsArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private TailnetSettings(string name, Input<string> id, TailnetSettingsState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/tailnetSettings:TailnetSettings", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class TailnetSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<double>? DevicesKeyDurationDays { get; set; }
        ...
        [Input("tailnetSettingsId")]
        public Input<string>? TailnetSettingsId { get; set; }
