...
namespace Pulumi.Unifi.Inputs
{
    ...
    public sealed class FirewallZonePolicySourceArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientMacs")]
        ...
        public FirewallZonePolicySourceArgs()
        {
        }
        public static new FirewallZonePolicySourceArgs Empty => new FirewallZonePolicySourceArgs();
    }
}
