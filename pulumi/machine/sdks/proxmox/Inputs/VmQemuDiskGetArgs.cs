...
namespace Pulumi.Proxmox.Inputs
{
    ...
    public sealed class VmQemuDiskGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("aio")]
        ...
        public VmQemuDiskGetArgs()
        {
        }
        public static new VmQemuDiskGetArgs Empty => new VmQemuDiskGetArgs();
    }
}
