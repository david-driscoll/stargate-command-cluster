...
namespace Tailscale.Client.Models
{
    ...
    public partial class DeviceRoutes : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The subnets this device requests to expose.</summary>
...
#nullable restore
        ...
        public List<string> AdvertisedRoutes { get; set; }
#endif
        /// <summary>The subnet routes for this device that have been approved by a tailnet admin.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Tailscale.Client.Models.DeviceRoutes"/> and sets the default values.
        /// </summary>
        public DeviceRoutes()
        {
        ...
        public static global::Tailscale.Client.Models.DeviceRoutes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Tailscale.Client.Models.DeviceRoutes();
        }
        /// <summary>
