...
namespace Pulumi.Proxmox.Inputs
{
    ...
    public sealed class LxcDiskTimeoutsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("create")]
        ...
        public LxcDiskTimeoutsGetArgs()
        {
        }
        public static new LxcDiskTimeoutsGetArgs Empty => new LxcDiskTimeoutsGetArgs();
    }
}
