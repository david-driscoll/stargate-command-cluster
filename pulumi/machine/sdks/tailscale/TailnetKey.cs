...
namespace Pulumi.Tailscale
{
    ...
    public partial class TailnetKey : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults
        /// to `false`.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated,
        /// but single-use keys will not. Possible values: 'always', 'never'.
        /// </summary>
        ...
        [Output("tailnetKeyId")]
        public Output<string> TailnetKeyId { get; private set; } = null!;
        ...
        public TailnetKey(string name, TailnetKeyArgs? args = null, CustomResourceOptions? options = null)
            : base("tailscale:index/tailnetKey:TailnetKey", name, args ?? new TailnetKeyArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private TailnetKey(string name, Input<string> id, TailnetKeyState? state = null, CustomResourceOptions? options = null)
            : base("tailscale:index/tailnetKey:TailnetKey", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class TailnetKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tailnetKeyId")]
        public Input<string>? TailnetKeyId { get; set; }
