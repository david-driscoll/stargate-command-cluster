...
namespace Pulumi.Authentik
{
    ...
    public partial class PropertyMappingGoogleWorkspace : global::Pulumi.CustomResource
    {
        ...
        [Output("propertyMappingGoogleWorkspaceId")]
        public Output<string> PropertyMappingGoogleWorkspaceId { get; private set; } = null!;
        ...
        public PropertyMappingGoogleWorkspace(string name, PropertyMappingGoogleWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingGoogleWorkspace:PropertyMappingGoogleWorkspace", name, args ?? new PropertyMappingGoogleWorkspaceArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }
        ...
        private PropertyMappingGoogleWorkspace(string name, Input<string> id, PropertyMappingGoogleWorkspaceState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/propertyMappingGoogleWorkspace:PropertyMappingGoogleWorkspace", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
    ...
    public sealed class PropertyMappingGoogleWorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("propertyMappingGoogleWorkspaceId")]
        public Input<string>? PropertyMappingGoogleWorkspaceId { get; set; }
