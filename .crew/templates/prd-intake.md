...
1. **Detect source:** File path, pasted text, or URL. Store a reference in `.crew/team.md` under `## PRD Source`.
...
- Work items tracked as issues (GitHub) or in `.crew/backlog.md` (offline mode)
