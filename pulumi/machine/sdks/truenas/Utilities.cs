...
namespace Pulumi.Truenas
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "truenas",
                    version: "0.11.1",
                    value: global::System.Convert.FromBase64String("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Rhcml1c2Jha3VuYXMvdHJ1ZW5hcyIsInZlcnNpb24iOiIwLjExLjEifX0=")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Truenas.version.txt");
    ...
    internal sealed class TruenasResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TruenasResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
